...
<body>
    ...
    <form action="" method="post">
        <input type="text" name="name" placeholder="Ennter Your Name" value="<?php echo $row['name']?>">
        <input type="text" name="userName" placeholder="Ennter Username" value="<?php echo $row['username']?>">
        <input type="password" name="password" placeholder="Ennter Password" value="<?php echo $row['password']?>">
        <select name="role" value="<?php echo $row['role']?>">
            <option value="">Role</option>
            <option value="tester">Tester</option>
            <option value="admin">Admin</option>
        </select>
        <a href=""><button type="submit" name="submit">Edit Account</button></a>
    </form>
</body>
</html>
